...
import { Bell, User, Clock, Tag, Megaphone, Calendar, Sparkles } from "lucide-react";
  ...
  useEffect(() => {
    const fetchNotices = async () => {
      try {
        ...
        // Add dummy dates if missing for demo visual flair
  ...
  return (
    <div className="space-y-8 pb-10">
      <div className="flex items-center justify-between">
         ...
         {user?.role === "admin" && (
            <Button size="sm" className="bg-indigo-600 hover:bg-indigo-500 shadow-indigo-500/20 shadow-lg">+ Add Notice</Button>
         )}
      </div>
